...
##changed raw file path on Ning's computer: dir_raw = '~/Google Drive/OHI China 2015/model_data/'
dir_raw = '~/github/chn/province2015/prep/5_CP' ### This has been changed to match Omar's computer; manually moved files from Google Drive to "3_CP" but appears they were overwritten in the cleaning process
