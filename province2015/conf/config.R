...
resilience_components = list('NP'  = c('layer'='np_harvest_weight'         , 'level'='region_id-category'),  # old: rnk_np_product_weight
...
pressures_components  = list('NP'  = c('layer'='np_harvest_weight'         , 'level'='region_id-category'),
                             'CS'  = c('layer'='cs_extent'                 , 'level'='region_id'),
...
# map configuration
map_lat=28.8751; map_lon=116.703; map_zoom=4
